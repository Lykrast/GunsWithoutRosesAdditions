...
import lykrast.gunswithoutrosesadditions.item.aether.GravititeShotgunItem;
...
public class CompatAether {
	...
	public static TagKey<EntityType<?>> UNLAUNCHABLE = TagKey.create(Registries.ENTITY_TYPE, new ResourceLocation(CompatModids.AETHER, "unlaunchable"));
