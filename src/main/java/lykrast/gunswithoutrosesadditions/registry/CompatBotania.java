...
public class CompatBotania {
	...
	public static void registerItems() {
		...
		terraShotgun = ModItems.initItem(() -> new TerraShotgun(ModItems.defP().durability(3058).fireResistant().rarity(Rarity.UNCOMMON), 0, 0.5, 20, 7, 26, 4).ignoreInvulnerability(true).fireSound(ModSounds.shotgun).repair(() -> Ingredient.of(TERRASTEEL)), "terra_shotgun");
